...
/**
 * copy from <a href="https://github.com/jpardogo/PagerSlidingTabStrip/blob/master/library%2Fsrc%2Fcom%2Fastuetz%2FPagerSlidingTabStrip.java>
 * and modified for some needs.
 * <p>
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        dividerWidth = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstDividerWidth, dividerWidth);
        ...
        isPaddingMiddle = a.getBoolean(R.styleable.PagerSlidingTabStrip_pstPaddingMiddle, isPaddingMiddle);
        tabTypefaceStyle = a.getInt(R.styleable.PagerSlidingTabStrip_pstTextStyle, Typeface.BOLD);
        tabTypefaceSelectedStyle = a.getInt(R.styleable.PagerSlidingTabStrip_pstTextSelectedStyle, Typeface.BOLD);
        tabTextColorSelected = a.getColorStateList(R.styleable.PagerSlidingTabStrip_pstTextColorSelected);
        textAlpha = a.getInt(R.styleable.PagerSlidingTabStrip_pstTextAlpha, textAlpha);
        a.recycle();
