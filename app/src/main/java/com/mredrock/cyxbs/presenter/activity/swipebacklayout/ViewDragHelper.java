...
package com.mredrock.cyxbs.presenter.activity.swipebacklayout;
...
public class ViewDragHelper {
     ...
     * callback's
     * {@link com.mredrock.cyxbs.presenter.activity.swipebacklayout.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.mredrock.cyxbs.presenter.activity.swipebacklayout.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link com.mredrock.cyxbs.presenter.activity.swipebacklayout.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)}
     ...
     * {@link com.mredrock.cyxbs.presenter.activity.swipebacklayout.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
